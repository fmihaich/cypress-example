...
const {CYPRESS_DIR} = require('./utils/common/dirDefinitions');
const {generateCucumberReport} = require('./utils/htmlReporter/generateCucumberHtmlReport');

const DEFAULT_ENV='local';
const DEFAULT_BROWSER='chrome';
const DEFAULT_REPORT_DIR = path.resolve(process.cwd(), CYPRESS_DIR, 'duck-reports');
